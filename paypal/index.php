...
// $paypal_id='PZ6X7H95JK5N6'; // Business email ID
$paypal_id='manage.amrecords@gmail.com'; // Business email ID
?>
<style>
body
{
...
<div class="product">            
    ...
    <input type="hidden" name="cmd" value="_xclick">c
    ...
    <input type="hidden" name="cancel_return" value="http://freelabel.net/paypal/cancel.php">
    <input type="hidden" name="return" value="http://freelabel.net/paypal/success.php">
