		...
		<link rel="stylesheet" type="text/css" href="http://freelabel.net/landing/view/form/css/normalize.css" />
		<!-- <link rel="stylesheet" type="text/css" href="http://freelabel.net/landing/view/form/css/demo.css" /> -->
		<link rel="stylesheet" type="text/css" href="http://freelabel.net/landing/view/form/css/component.css" />
		<link rel="stylesheet" type="text/css" href="http://freelabel.net/landing/view/form/css/cs-select.css" />
		<link rel="stylesheet" type="text/css" href="http://freelabel.net/landing/view/form/css/cs-skin-boxes.css" />
		...
		<script src="http://freelabel.net/landing/view/form/js/classie.js"></script>
		<script src="http://freelabel.net/landing/view/form/js/selectFx.js"></script>
		<script src="http://freelabel.net/landing/view/form/js/fullscreenForm.js"></script>
		<script>
			(function() {
