...
<script type="text/javascript" src="<?php echo HTTP; ?>jplayer/lib/jquery.min.js"></script>
<script type="text/javascript" src="<?php echo HTTP; ?>jplayer/dist/jplayer/jquery.jplayer.min.js"></script>
...
<body>
		...
		<div id="jp_container" class="demo-container">
			<ul>
				...
				<li><a href="http://streaming.radio.co/s95fa8cba2/listen" class="track track-default">Cro Magnon Man</a></li>
				<li> | </li>
				<li><a href="http://streaming.radio.co/s95fa8cba2/listen" class="track">The Separation</a></li>
				<li> | </li>
				<li><a href="hhttp://streaming.radio.co/s95fa8cba2/listen" class="track">Lismore</a></li>
				<li> | </li>
				<li><a href="http://streaming.radio.co/s95fa8cba2/listen" class="track">Thin Ice</a></li>
			</ul>
			<p>
