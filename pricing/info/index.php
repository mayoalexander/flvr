...
<html lang="en" class="no-js">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="http://freelabel.net/pricing/info/css/default.css" />
		<link rel="stylesheet" type="text/css" href="http://freelabel.net/pricing/info/css/component.css" />
		<script src="http://freelabel.net/pricing/info/js/modernizr.custom.js"></script>
	</head>
	<body>
		<div class="container">
		...
		<script src="http://freelabel.net/pricing/info/js/jquery.cbpNTAccordion.min.js"></script>
		<script>
			$( function() {
				/*
