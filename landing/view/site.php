          ...
          <div class="col-md-4 p-t-md wp wp-5">
            <div class="card pricing-box">
              ...
              <ul class="list-group list-group-flush p-x">
                <li class="list-group-item">Upload & Save Music</li>
                <li class="list-group-item">Online Storefront</li>
                <li class="list-group-item">Unlimited Cloud Storage</li>
                <li class="list-group-item">Connect Social Networks to Promo Campaigns</li>
              </ul>
              <a href="http://freelabel.net/confirm/sub" class="btn btn-primary-outline">Get Started</a>
            </div>
          </div>
          <div class="col-md-4 stacking-top">
            <div class="card pricing-box pricing-best p-x-0">
              ...
              <div class="card-block">
                ...
                <h4 class="card-text">
                  <sup class="pricing-box-currency">$</sup>
                  <span class="pricing-box-price">59</span>
                  <small class="text-muted text-uppercase">/month</small>
                </h4>
              </div>
              <ul class="list-group list-group-flush p-x">
              ...
              <a href="http://freelabel.net/confirm/basic" class="btn btn-primary">Get Started</a>
            </div>
          </div>
