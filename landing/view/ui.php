<body class="bg-faded p-t-md">
  <div class="container">
    <h3 class="p-y text-center">Land.io <strong>UI Elements</strong></h3>
  </div>
  ...
  <nav class="navbar navbar-dark bg-inverse">
    <div class="container">
      ...
      <div id="collapsingMobileUserInverse" class="collapse navbar-toggleable-custom dropdown-menu-custom p-x hidden-md-up" role="tabpanel" aria-labelledby="collapsingMobileUserInverse">
        <div class="media m-t">
          <div class="media-left">
            <img src="img/face5.jpg" height="60" width="60" alt="Avatar" class="img-circle">
          </div>
  ...
  <h4 class="m-y-md text-center">Video JS</h4>
  ...
  <hr class="invisible">
  <h4 class="m-y-md text-center">Vimeo (Bootstrap modal)</h4>
  <figure class="has-light-mask">
    <a class="icon-play-button" href="#videoModal" data-toggle="modal" data-target="#videoModal">
      <span class="icon-play"></span>
    </a>
    <img class="img-responsive img-responsive-custom" src="img/video-poster.jpg" alt="Video poster">
  </figure>
  <hr class="invisible">
  <h4 class="m-y-md text-center">YouTube (Bootstrap modal)</h4>
  <figure class="has-light-mask">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-7">
          <ul class="list-inline m-b-0">
            <li><a href="http://tympanus.net/codrops/?p=25217">About Land.io</a></li>
            <li class="active"><a href="ui-elements.html">UI Kit</a></li>
  ...
  <!-- only needed Bootstrap JS components + 3rd party plugins + custom -->
