		...
		<!-- <link rel="stylesheet" type="text/css" href="http://freelabel.net/landing/view/slider/css/default.css" /> -->
		<link rel="stylesheet" type="text/css" href="http://freelabel.net/landing/view/slider/css/component.css" />
		<script src="http://freelabel.net/landing/view/slider/js/modernizr.custom.js"></script>
		...
		<script src="http://freelabel.net/landing/view/slider/js/jquery.cbpContentSlider.min.js"></script>
		<script>
			$(function() {
				/*
