...
{          
    ...
    elseif($_POST['action']=="signup")
    {
        ...
        $email      = mysqli_real_escape_string($connection,$_POST['email']);
        $password   = mysqli_real_escape_string($connection,$_POST['password']);
        $query = "SELECT email FROM users where user_email='".$email."'";
        ...
        {
            mysqli_query($connection,"insert into users(user_name,user_email,user_password) values('".$name."','".$email."','".md5($password)."')");
    ...
    elseif($_POST['action']=="password")
    {
        ...
        else
        {
            ...
            if(count($Results)>=1)
            {
                ...
                $from = 'info@AMRadioLIVE.com';
                $body='Hi, <br/> <br/>Your Membership ID is '.$Results['id'].' <br><br>Click here to reset your password http://freelabel.net/submit/recovery/reset.php?encrypt='.$encrypt.'&action=reset   <br/> <br/>--<br>PHPGang.com<br>Solve your problems.';
