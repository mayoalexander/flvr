<?php 
header('Location: "http://freelabel.net/form/upload"');
exit;
include('upload/index.php');
exit;
//exit;
//header('Location: http://freelabel.net/submit/upload');
...
<html lang="en" class="no-js">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo HTTP.'submit/'; ?>css/normalize.css" />
		<link rel="stylesheet" type="text/css" href="<?php echo HTTP.'submit/'; ?>css/demo.css" />
		<link rel="stylesheet" type="text/css" href="<?php echo HTTP.'submit/'; ?>css/component.css" />
		<link rel="stylesheet" type="text/css" href="<?php echo HTTP.'submit/'; ?>css/cs-select.css" />
		<link rel="stylesheet" type="text/css" href="<?php echo HTTP.'submit/'; ?>css/cs-skin-boxes.css" />
		<style type="text/css">
		body {
		...
		<script src="<?php echo HTTP.'submit/'; ?>js/modernizr.custom.js"></script>
	</head>
	<body>
		<div class="container">
