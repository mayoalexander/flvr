...
define("MESSAGE_ACCOUNT_NOT_ACTIVATED", "Your account is not activated yet. Please click the confirmation URL in your email or click here to reset your account.");
...
define("MESSAGE_LOGIN_FAILED", "Username or Password not correct. Is your CAPS lock on? If you're still getting stuck, you can <a href=\"http://freelabel.net/user/password_reset.php\">Reset Your Password.</a>");
...
define("MESSAGE_REGISTRATION_ACTIVATION_SUCCESSFUL", "<script>alert('Activation was successful! You can now log in!');window.location.assign('http://freelabel.net/login/');</script>");
...
define("MESSAGE_VERIFICATION_MAIL_SENT", "Your account has been successfully created. Please click the Verification Link we sent you to your email!");
define("MESSAGE_USER_DOES_NOT_EXIST", "That username does not exist in our records..");
...
define("WORDING_REQUEST_PASSWORD_RESET", "Enter your username so we can send you an email with instructions on how to reset your password!");
define("WORDING_RESET_PASSWORD", "Email Me Password Reset");
