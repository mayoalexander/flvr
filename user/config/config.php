 ...
 */
define("DB_HOST", "amrusers.db.13071759.hostedresource.com");
define("DB_NAME", "amrusers");
define("DB_USER", "amrusers");
...
define("COOKIE_DOMAIN", "http://freelabel.net");
...
define("EMAIL_SMTP_HOST", "freelabel.net");
define("EMAIL_SMTP_AUTH", true);
 ...
 */
define("EMAIL_PASSWORDRESET_URL", "http://freelabel.net/user/password_reset.php");
define("EMAIL_PASSWORDRESET_FROM", "no-reply@freelabel.net");
define("EMAIL_PASSWORDRESET_FROM_NAME", "FREELABEL Support");
define("EMAIL_PASSWORDRESET_SUBJECT", "FREELABEL PASSWORD RESET");
 ...
 */
define("EMAIL_VERIFICATION_URL", "http://freelabel.net/user/register.php");
define("EMAIL_VERIFICATION_FROM", "no-reply@freelabel.net");
define("EMAIL_VERIFICATION_FROM_NAME", "FREELABEL REGISTRATION");
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for your FREELABEL Account");
